    ...
    <div class="container">
        <div class="row">
            <div class="col-md-9 col-sm-8 col-12">
                <div class="blog-list-left"> <img src="{{ asset('public/img')}}/{{ $blog->thumbnail }}" alt="img">
                    <div class="data-box">
                ...
                <div class="blog-list-right">
                    ...
                    @foreach($recentBlogs as $blog)
                        <div class="latest-posts">
                            <div class="row">
                                <div class="col-md-5 col-sm-5 col-4 latest-posts-img"> <img src="{{ asset('public/img') }}/{{ $blog->thumbnail}}"
                                            alt="blog-img"> </div>
